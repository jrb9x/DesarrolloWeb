...
public class Ejercicio1 {
    ...
    public Ejercicio1(Integer numerador, Integer denominador) {
        this.numerador = numerador;
        this.denominador = denominador;
    }

    public Ejercicio1 suma(Ejercicio1 racional) {

    	Ejercicio1 racionalResultado = new Ejercicio1();
    ...
    public Ejercicio1 resta(Ejercicio1 racional) {
    	Ejercicio1 racionalResultado = new Ejercicio1();
    ...
    public Ejercicio1 multiplicacion(Ejercicio1 racional) {
    ...
    public Ejercicio1 division(Ejercicio1 racional) {
    ...
    public Boolean mayorQue(Ejercicio1 racional) {
