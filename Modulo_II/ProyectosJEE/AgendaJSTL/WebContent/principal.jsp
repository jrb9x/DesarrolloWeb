            ...
            <tr>
                ...
                <c:if test="${sessionScope.listaContactos != null}" > 
                	...
                	<td> <c:out value="${contacto.fecha}"/> </td>
   					...
   					<td><a href="ServletGestionContacto?idModificar= <c:out value="${contacto.id}"/> "><img title="Modificar" src="iconos/modificar.png" width="25px" height="25px"></a></td>
   					<td><a href="ServletEliminar?idEliminar= <c:out value="${contacto.id}"/> "><img title="eliminar" src="iconos/eliminar.png" width="25px" height="25px"></a></td></tr>
                	</c:forEach>
				</c:if>
    	</table>
    </section>
