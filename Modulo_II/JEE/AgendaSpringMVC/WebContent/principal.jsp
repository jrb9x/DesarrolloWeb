    ...
    <header>
        <table>
            ...
            <% Usuario usuario = (Usuario) session.getAttribute("usuario"); %>
                <td><div id="aniadir"><a href="gestion.do"><img title="nuevo" src="iconos/aniadir.png" width="50px" height="50px"/></a></div></td>
           ...
           if(listaContactos != null){
          		for (Contacto contacto : listaContactos) {
   				out.print("<tr><td>" + contacto.getNombre() + "</td>"+
   					...
   					"<td><a href=\"gestion.do?idModificar=" + contacto.getId() + "\"><img title=\"Modificar\" src=\"iconos/modificar.png\" width=\"25px\" height=\"25px\"></a></td>"+
   					"<td><a href=\"eliminar.do?idEliminar=" + contacto.getId() + "\"><img title=\"eliminar\" src=\"iconos/eliminar.png\" width=\"25px\" height=\"25px\"></a></td></tr>");
   				}
           }
    %>
    </table>
